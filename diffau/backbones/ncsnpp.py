...
class NCSNpp(nn.Module):
    ...
    def __init__(self,
        low_order_channels = 4,
        high_order_channels = 16,
        scale_by_sigma = True,
        nonlinearity = 'swish',
        nf = 128,
        ...
        **unused_kwargs
        ...
        num_input_channels =  2 * (low_order_channels + high_order_channels) # imag/real
        num_output_channels = 2 * high_order_channels # imag/real
        self.output_layer = nn.Conv2d(num_input_channels, num_output_channels, 1)
    ...
    def forward(self, x, time_cond):
        ...
        num_output_channels = h.shape[1]
        h = torch.complex(h[:,:num_output_channels//2],h[:,num_output_channels//2:]) #first half are the real and second are the imaginary
        return h
